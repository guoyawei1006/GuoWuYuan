...
import fragment.BuFragment;
import fragment.CaiFragment;
import fragment.RuFragment;

public class BuMenActivity extends FragmentActivity {
    //入驻部门
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bu_men);
        context = this;
    ...
    private void InitViewPager() {
        ...
        pictureTextView.setTextColor(Color.BLUE);
    ...
    private void InitFragment(){
        ...
        fragmentArrayList.add(new RuFragment());
        fragmentArrayList.add(new CaiFragment());
        fragmentArrayList.add(new BuFragment());
            ...
            switch (position){
                ...
                case 2:
                    ...
                    if (currIndex == 0) {
                        ...
                        resetTextViewTextColor();
                        musicTextView.setTextColor(Color.BLUE);
